...
\includegraphics[width=\linewidth]{/tmp/pylatex/6e7272f9-1555-4a7b-9698-02d23f02ad53.pdf}
\caption{Q{-}score distribution plot (all reads all cycles)}
\end{subfigure}
\begin{subfigure}{0.45\linewidth}
\includegraphics[width=\linewidth]{/tmp/pylatex/fcc923d3-54ab-4a6a-b47b-fcbf20086e97.pdf}
\caption{Q{-}score heat map}
\end{subfigure}
\begin{subfigure}{0.45\linewidth}
\includegraphics[width=\linewidth]{/tmp/pylatex/a7e3a1b2-ea52-40cd-a3da-b5ce7e3e54cb.pdf}
...
\end{tabular}
\begin{subfigure}{0.45\linewidth}
\includegraphics[width=\linewidth]{/tmp/pylatex/67f35cfb-953e-4642-9678-f2c089ea49bb.pdf}
\end{subfigure}
\end{figure}
