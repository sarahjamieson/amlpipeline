...
\includegraphics[width=\linewidth]{/tmp/pylatex/5678702c-8163-4e69-9fa6-0df2824c40d7.pdf}
\caption{Q{-}score distribution plot (all reads all cycles)}
\end{subfigure}
\begin{subfigure}{0.45\linewidth}
\includegraphics[width=\linewidth]{/tmp/pylatex/07e3efcc-f14d-4977-9c17-4ae34041508a.pdf}
\caption{Q{-}score heat map}
\end{subfigure}
\begin{subfigure}{0.45\linewidth}
\includegraphics[width=\linewidth]{/tmp/pylatex/ec33af72-bc9a-45db-9568-8b8a5547cb58.pdf}
...
\end{tabular}
\begin{subfigure}{0.45\linewidth}
\includegraphics[width=\linewidth]{/tmp/pylatex/c3bec1f6-e2d4-4462-802c-634b96080422.pdf}
\end{subfigure}
\end{figure}
