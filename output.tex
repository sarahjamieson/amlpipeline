...
\includegraphics[width=\linewidth]{/tmp/pylatex/19a69a0d-2ac5-491a-afd1-f311b3f4feb9.pdf}
\caption{Q{-}score distribution plot (all reads all cycles)}
\end{subfigure}
\begin{subfigure}{0.45\linewidth}
\includegraphics[width=\linewidth]{/tmp/pylatex/5df4f149-d862-4be1-99dc-63883b060b1e.pdf}
\caption{Q{-}score heat map}
\end{subfigure}
\begin{subfigure}{0.45\linewidth}
\includegraphics[width=\linewidth]{/tmp/pylatex/c1af9741-54a1-4d5b-886a-9dd67907180a.pdf}
...
\end{tabular}
\begin{subfigure}{0.45\linewidth}
\includegraphics[width=\linewidth]{/tmp/pylatex/aba0fc34-319d-456a-93db-660f3475a67a.pdf}
\end{subfigure}
\end{figure}
